...
const (
	ProtoVersion       = 1
	ContractHash       = "sha256:3576151e0d4d4b80e36bd2489dd8c9075d503f38c862efc5dd8fec5c768cdc65"
...
const (
	OsTypeOutcomeTyped                  OsTypeOutcome = "typed"
	OsTypeOutcomeRefusedByGate          OsTypeOutcome = "refusedByGate"
	OsTypeOutcomePlanFailed             OsTypeOutcome = "planFailed"
	OsTypeOutcomeHandServiceUnavailable OsTypeOutcome = "handServiceUnavailable"
)

var OsTypeOutcomeValues = []OsTypeOutcome{
	OsTypeOutcomeTyped,
	OsTypeOutcomeRefusedByGate,
	OsTypeOutcomePlanFailed,
	OsTypeOutcomeHandServiceUnavailable,
}
...
const (
	...
	PrimChatReadPeerPhone                 = "chat.readPeerPhone"
	PrimChatReadThread                    = "chat.readThread"
	PrimChatReadUnreadTotal               = "chat.readUnreadTotal"
	PrimChatReadWechatExchangeOutcome     = "chat.readWechatExchangeOutcome"
	PrimChatRevealPeerPhone               = "chat.revealPeerPhone"
...
var Primitives = map[string]PrimitiveMeta{
	...
	PrimChatReadList:                      {Ver: 1, Class: ClassIntrusive, Batch: BatchS, PlatformSideEffect: "none", ExecBudgetMs: 480000, DeadlineMs: 600000, LeaseMs: 60000, ArgsSchema: "ChatReadListArgs", DataSchema: "ChatReadListData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "surface.im", "login.in", "manualQuiet"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	PrimChatReadPeerPhone:                 {Ver: 1, Class: ClassReadonly, Batch: BatchX, PlatformSideEffect: "", ExecBudgetMs: 5000, DeadlineMs: 30000, LeaseMs: 0, ArgsSchema: "ChatReadPeerPhoneArgs", DataSchema: "ChatReadPeerPhoneData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "surface.im", "login.in"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	...
	PrimChatReadUnreadTotal:               {Ver: 1, Class: ClassReadonly, Batch: BatchS, PlatformSideEffect: "", ExecBudgetMs: 5000, DeadlineMs: 30000, LeaseMs: 0, ArgsSchema: "ChatReadUnreadTotalArgs", DataSchema: "ChatReadUnreadTotalData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	...
	PrimJobPrepareDraft:                   {Ver: 1, Class: ClassIntrusive, Batch: BatchS, PlatformSideEffect: "none", ExecBudgetMs: 360000, DeadlineMs: 480000, LeaseMs: 45000, ArgsSchema: "JobPrepareDraftArgs", DataSchema: "JobPrepareDraftData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	PrimJobPublishDraft:                   {Ver: 1, Class: ClassEffectful, Batch: BatchX, PlatformSideEffect: "", ExecBudgetMs: 480000, DeadlineMs: 600000, LeaseMs: 60000, ArgsSchema: "JobPrepareDraftArgs", DataSchema: "JobPublishDraftData", GuardsSchema: "JobPublishDraftGuards", EvidenceSchema: "JobPublishDraftEvidence", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet", "witness/1"}, VerificationPrimitive: "job.readPublishedList", VerificationVer: 1, VerificationMaxRounds: 3, ContextOptionalBeforeBinding: false},
	PrimJobReadClassCandidates:            {Ver: 1, Class: ClassIntrusive, Batch: BatchS, PlatformSideEffect: "none", ExecBudgetMs: 300000, DeadlineMs: 480000, LeaseMs: 60000, ArgsSchema: "JobReadClassCandidatesArgs", DataSchema: "JobReadClassCandidatesData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	PrimJobReadKeywordVocabulary:          {Ver: 1, Class: ClassIntrusive, Batch: BatchS, PlatformSideEffect: "none", ExecBudgetMs: 300000, DeadlineMs: 480000, LeaseMs: 60000, ArgsSchema: "JobReadKeywordVocabularyArgs", DataSchema: "JobReadKeywordVocabularyData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	PrimJobReadPublishedList:              {Ver: 1, Class: ClassIntrusive, Batch: BatchS, PlatformSideEffect: "none", ExecBudgetMs: 180000, DeadlineMs: 300000, LeaseMs: 30000, ArgsSchema: "JobReadPublishedListArgs", DataSchema: "JobReadPublishedListData", GuardsSchema: "", EvidenceSchema: "", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet"}, VerificationPrimitive: "", VerificationVer: 0, VerificationMaxRounds: 0, ContextOptionalBeforeBinding: false},
	PrimJobTakeOffline:                    {Ver: 1, Class: ClassEffectful, Batch: BatchX, PlatformSideEffect: "", ExecBudgetMs: 240000, DeadlineMs: 480000, LeaseMs: 60000, ArgsSchema: "JobTakeOfflineArgs", DataSchema: "JobTakeOfflineData", GuardsSchema: "JobTakeOfflineGuards", EvidenceSchema: "JobTakeOfflineEvidence", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet", "witness/1"}, VerificationPrimitive: "job.readPublishedList", VerificationVer: 1, VerificationMaxRounds: 3, ContextOptionalBeforeBinding: false},
