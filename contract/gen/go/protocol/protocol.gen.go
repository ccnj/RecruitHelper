...
const (
	ProtoVersion       = 1
	ContractHash       = "sha256:ac6b75efc2fe26d4fd3729cf4253a6d8cf8cc7dce03a0dc12c09c13f8a8f52b0"
...
var Primitives = map[string]PrimitiveMeta{
	...
	PrimJobPublishDraft:                   {Ver: 1, Class: ClassEffectful, Batch: BatchX, PlatformSideEffect: "", ExecBudgetMs: 240000, DeadlineMs: 600000, LeaseMs: 150000, ArgsSchema: "JobPrepareDraftArgs", DataSchema: "JobPublishDraftData", GuardsSchema: "JobPublishDraftGuards", EvidenceSchema: "JobPublishDraftEvidence", Preconditions: []string{"context.platform", "context.accountRef", "context.expectedPrincipalFingerprint", "login.in", "manualQuiet", "witness/1"}, VerificationPrimitive: "job.readPublishedList", VerificationVer: 1, VerificationMaxRounds: 3, ContextOptionalBeforeBinding: false},
