...
func TestRoundUpToInterviewTimeGrid(t *testing.T) {
	cases := []struct {
		...
		// 公共格 30 分钟(2026-09-02 批 D 2.4):智联 5 分钟格与 BOSS 宽松时间 30 分钟格的最粗公共格。
		{"整点不变", 1785391200000, 1785391200000},                 // 2026-07-30 14:00:00
		{"半点格点不变", 1785393000000, 1785393000000},               // 14:30:00
		{"14:05 不再是格点,进到 14:30", 1785391500000, 1785393000000}, // 14:05:00
		{"14:03 进到 14:30", 1785391380000, 1785393000000},       // 14:03:00
		{"14:01 进到 14:30", 1785391260000, 1785393000000},       // 14:01:00
		{"零点后一毫秒进整格", 1785391200001, 1785393000000},            // 14:00:00.001
